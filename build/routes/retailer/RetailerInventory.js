...
router.get("/get/DefaultAndCustom/retailer/:retailerId", RetailerInventory_1.default.readDefaultAndCustomInventory);
router.get("/forecast/:retailerId/:numDays", RetailerInventory_1.default.inventoryForecast);
router.get("/forecast-detailed/:retailerId/:numDays", RetailerInventory_1.default.inventoryForecastDetailed);
